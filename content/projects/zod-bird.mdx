...
repository: designedbydineth/zod-bird
date: "2023-05-21"
published: true
...
```ts
import { Tinybird } from "@designedbydineth/zod-bird";
import { z } from "zod";
...
const res = await getEvents({ tenantId: "designedbydineth" })
...
```
npm i @designedbydineth/zod-bird
```
